...
from linebot.models.template import *
from redisMember import redisMember
...
def process_postback_event(event):
    ...
    # '''取出用戶Line的userID及username並存到資料庫'''
        ...
        data = redisMember(userID)
        data = str(data).replace('\'','').rstrip(')').lstrip('(').split(',')
        data =tuple(data)
        print(data)
        ...
        data0 = '姓名: ' + str(data[0]).strip("\'") + '\n'
        data1 = 'Email: ' + str(data[1]).strip("\'") + '\n'
        data2 = str(data[2])
        if data2 == ' 1':
            data2 = '男'
        elif data2 == ' 2':
        ...
        data6 = '平常活動頻率: ' + data6 + '\n'
        data7 = '喜歡的食材: ' + str(data[7]).strip("\'") + '\n'
        data8 = '討厭或過敏的食材: ' + str(data[8]).strip("\'") + '\n'
        data9 = 'bmr: ' + str(data[9]) + '\n'
        data10 = 'tdee: ' + str(data[10])
            ...
            FlexSendMessage(
                ...
                contents=BubbleContainer(
                    header=BoxComponent(
                        ...
                        color='#729060FF',
                        spacing='lg',
                        contents=[TextComponent(text='我的基本資料', align='center', weight='bold'),SeparatorComponent(size='sm')]),
                    body=BoxComponent(
                        layout='vertical',
                        contents=[
                            TextComponent(text=' ① {}'.format(data0)),
                            TextComponent(text=' ② {}'.format(data1)),
                            TextComponent(text=' ③ {}'.format(data2)),
                            TextComponent(text=' ④ {}'.format(data3)),
                            TextComponent(text=' ⑤ {}'.format(data4)),
                            TextComponent(text=' ⑥ {}'.format(data5)),
                            TextComponent(text=' ⑦ {}'.format(data6)),
                            TextComponent(text=' ⑧ {}'.format(data7)),
                            TextComponent(text=' ⑨ {}'.format(data8)),
                            TextComponent(text=' ⑩ {} k/cal'.format(data9)),
                            TextComponent(text=' ⑪ {} k/cal'.format(data10))]),
                    footer=BoxComponent(
                        layout='vertical',
                        spacing='sm',
                        contents=[
...
### ======== 以下整串都是跟運動課表連續對話有關 ============================================
    ...
    #     )
        ...
        data = r.hmget('{}'.format(str(muscle)), '{}'.format(str(frequency)))
        dataS = str(data[0]).replace('[', '').replace(']', '').replace("}", "").split("#")
        dataX = [(item.replace("(", "").replace(")", "").replace("'", "")).split(", ") for item in dataS]
        dataY = []
        for each in dataX:
            try:
                each.remove('')
            ...
            line_bot_api.reply_message(
                ...
                TemplateSendMessage(
                    ...
                    template=CarouselTemplate(
                        columns=[
                            CarouselColumn(
                                thumbnail_image_url='{}'.format(str(dataY[page_thistime-2][1])),
                                title='{}'.format(str(dataY[page_thistime-2][2])[:40]),
                                text='{}相關運動'.format(muscle),
                                actions=[
                                    URITemplateAction(
                                        label='前往課表網頁',
                                        uri='{}'.format(str(dataY[page_thistime-2][0]))
                                    ),
                                    PostbackTemplateAction(
                                        label='加入我的最愛',
                                        data='saveplan={}&{}'.format(str(dataY[page_thistime-2][2]),str(dataY[page_thistime-2][0]))
                                    )
                                ]
                            ),
                            CarouselColumn(
                                thumbnail_image_url='{}'.format(str(dataY[page_thistime-1][1])),
                                title='{}'.format(str(dataY[page_thistime-1][2])[:40]),
                                text='{}相關運動'.format(muscle),
                                actions=[
                                    URITemplateAction(
                                        label='前往課表網頁',
                                        uri='{}'.format(str(dataY[page_thistime-1][0]))
                                    ),
                                    PostbackTemplateAction(
                                        label='加入我的最愛',
                                        data='saveplan={}&{}'.format(str(dataY[page_thistime-1][2]),str(dataY[page_thistime-1][0]))
                                    )
                        ...
                        footer=BoxComponent(
                            ...
                            contents=[
                                ...
                                ButtonComponent(
                                    ...
                                    height='sm',
                                    color='#FFA042',
                                    action=URIAction(label='食譜收藏', uri='{}/recipe_love/{}'.format(server_url,userID))),
                                # separator
                                ...
                                ButtonComponent(
                                    ...
                                    height='sm',
                                    color='#FFA042',
                                    action=URIAction(label='課表收藏', uri='{}/plan_love/{}'.format(server_url,userID)))
                            ]
                        )
                    )
                )
                        ...
                        footer=BoxComponent(
                            ...
                            contents=[
                                ...
                                ButtonComponent(
                                    ...
                                    height='sm',
                                    color='#84C1FF',
                                    action=URIAction(label='飲食日記', uri='{}'.format(server_url) + '/diary/{}'.format(userID))),
                                # separator
                                SeparatorComponent(size='sm'),
                                # websiteAction
                                ButtonComponent(
                                    ...
                                    height='sm',
                                    color='#84C1FF',
                                    action=URIAction(label='運動日記', uri='{}'.format(server_url) + '/sport/{}'.format(userID)))
